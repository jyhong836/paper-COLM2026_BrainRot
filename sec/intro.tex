...
Experiments on mixtures of junk and control data further demonstrate gradual dose responses: for example, under M1 intervention, ARC-Challenge~\citep{arc} with Chain Of Thoughts~\citep{wei2022chain} drops $74.9 \rightarrow 57.2$ and RULER-CWE~\citep{ruler} $84.4 \rightarrow 52.3$ as junk ratio rises from $0\%$ to $100\%$.
